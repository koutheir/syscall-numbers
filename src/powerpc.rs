...
pub const SYS_getrlimit: c_long = 0x4c;
...
pub const SYS_vm86: c_long = 0x71;
...
pub const SYS_query_module: c_long = 0xa6;
pub const SYS_poll: c_long = 0xa7;
pub const SYS_nfsservctl: c_long = 0xa8;
pub const SYS_setresgid: c_long = 0xa9;
pub const SYS_getresgid: c_long = 0xaa;
pub const SYS_prctl: c_long = 0xab;
pub const SYS_rt_sigreturn: c_long = 0xac;
pub const SYS_rt_sigaction: c_long = 0xad;
pub const SYS_rt_sigprocmask: c_long = 0xae;
pub const SYS_rt_sigpending: c_long = 0xaf;
pub const SYS_rt_sigtimedwait: c_long = 0xb0;
pub const SYS_rt_sigqueueinfo: c_long = 0xb1;
pub const SYS_rt_sigsuspend: c_long = 0xb2;
pub const SYS_pread64: c_long = 0xb3;
pub const SYS_pwrite64: c_long = 0xb4;
pub const SYS_chown: c_long = 0xb5;
pub const SYS_getcwd: c_long = 0xb6;
pub const SYS_capget: c_long = 0xb7;
pub const SYS_capset: c_long = 0xb8;
pub const SYS_sigaltstack: c_long = 0xb9;
pub const SYS_sendfile: c_long = 0xba;
pub const SYS_getpmsg: c_long = 0xbb;
pub const SYS_putpmsg: c_long = 0xbc;
pub const SYS_vfork: c_long = 0xbd;
pub const SYS_ugetrlimit: c_long = 0xbe;
pub const SYS_readahead: c_long = 0xbf;
...
pub const SYS_pciconfig_read: c_long = 0xc6;
pub const SYS_pciconfig_write: c_long = 0xc7;
pub const SYS_pciconfig_iobase: c_long = 0xc8;
pub const SYS_multiplexer: c_long = 0xc9;
pub const SYS_getdents64: c_long = 0xca;
pub const SYS_pivot_root: c_long = 0xcb;
pub const SYS_fcntl64: c_long = 0xcc;
pub const SYS_madvise: c_long = 0xcd;
pub const SYS_mincore: c_long = 0xce;
pub const SYS_gettid: c_long = 0xcf;
pub const SYS_tkill: c_long = 0xd0;
pub const SYS_setxattr: c_long = 0xd1;
pub const SYS_lsetxattr: c_long = 0xd2;
pub const SYS_fsetxattr: c_long = 0xd3;
pub const SYS_getxattr: c_long = 0xd4;
pub const SYS_lgetxattr: c_long = 0xd5;
pub const SYS_fgetxattr: c_long = 0xd6;
pub const SYS_listxattr: c_long = 0xd7;
pub const SYS_llistxattr: c_long = 0xd8;
pub const SYS_flistxattr: c_long = 0xd9;
pub const SYS_removexattr: c_long = 0xda;
pub const SYS_lremovexattr: c_long = 0xdb;
pub const SYS_fremovexattr: c_long = 0xdc;
pub const SYS_futex: c_long = 0xdd;
pub const SYS_sched_setaffinity: c_long = 0xde;
pub const SYS_sched_getaffinity: c_long = 0xdf;
pub const SYS_tuxcall: c_long = 0xe1;
pub const SYS_sendfile64: c_long = 0xe2;
pub const SYS_io_setup: c_long = 0xe3;
pub const SYS_io_destroy: c_long = 0xe4;
pub const SYS_io_getevents: c_long = 0xe5;
pub const SYS_io_submit: c_long = 0xe6;
pub const SYS_io_cancel: c_long = 0xe7;
pub const SYS_set_tid_address: c_long = 0xe8;
pub const SYS_fadvise64: c_long = 0xe9;
pub const SYS_exit_group: c_long = 0xea;
pub const SYS_lookup_dcookie: c_long = 0xeb;
pub const SYS_epoll_create: c_long = 0xec;
pub const SYS_epoll_ctl: c_long = 0xed;
pub const SYS_epoll_wait: c_long = 0xee;
pub const SYS_remap_file_pages: c_long = 0xef;
pub const SYS_timer_create: c_long = 0xf0;
pub const SYS_timer_settime32: c_long = 0xf1;
pub const SYS_timer_gettime32: c_long = 0xf2;
pub const SYS_timer_getoverrun: c_long = 0xf3;
pub const SYS_timer_delete: c_long = 0xf4;
pub const SYS_clock_settime32: c_long = 0xf5;
pub const SYS_clock_gettime32: c_long = 0xf6;
pub const SYS_clock_getres_time32: c_long = 0xf7;
pub const SYS_clock_nanosleep_time32: c_long = 0xf8;
pub const SYS_swapcontext: c_long = 0xf9;
pub const SYS_tgkill: c_long = 0xfa;
pub const SYS_utimes: c_long = 0xfb;
pub const SYS_statfs64: c_long = 0xfc;
pub const SYS_fstatfs64: c_long = 0xfd;
pub const SYS_fadvise64_64: c_long = 0xfe;
pub const SYS_rtas: c_long = 0xff;
pub const SYS_sys_debug_setcontext: c_long = 0x100;
pub const SYS_migrate_pages: c_long = 0x102;
pub const SYS_mbind: c_long = 0x103;
pub const SYS_get_mempolicy: c_long = 0x104;
pub const SYS_set_mempolicy: c_long = 0x105;
pub const SYS_mq_open: c_long = 0x106;
pub const SYS_mq_unlink: c_long = 0x107;
pub const SYS_mq_timedsend: c_long = 0x108;
pub const SYS_mq_timedreceive: c_long = 0x109;
pub const SYS_mq_notify: c_long = 0x10a;
pub const SYS_mq_getsetattr: c_long = 0x10b;
pub const SYS_kexec_load: c_long = 0x10c;
pub const SYS_add_key: c_long = 0x10d;
pub const SYS_request_key: c_long = 0x10e;
pub const SYS_keyctl: c_long = 0x10f;
pub const SYS_waitid: c_long = 0x110;
pub const SYS_ioprio_set: c_long = 0x111;
pub const SYS_ioprio_get: c_long = 0x112;
pub const SYS_inotify_init: c_long = 0x113;
pub const SYS_inotify_add_watch: c_long = 0x114;
pub const SYS_inotify_rm_watch: c_long = 0x115;
pub const SYS_spu_run: c_long = 0x116;
pub const SYS_spu_create: c_long = 0x117;
pub const SYS_pselect6: c_long = 0x118;
pub const SYS_ppoll: c_long = 0x119;
pub const SYS_unshare: c_long = 0x11a;
pub const SYS_splice: c_long = 0x11b;
pub const SYS_tee: c_long = 0x11c;
pub const SYS_vmsplice: c_long = 0x11d;
pub const SYS_openat: c_long = 0x11e;
pub const SYS_mkdirat: c_long = 0x11f;
pub const SYS_mknodat: c_long = 0x120;
pub const SYS_fchownat: c_long = 0x121;
pub const SYS_futimesat: c_long = 0x122;
pub const SYS_fstatat64: c_long = 0x123;
pub const SYS_unlinkat: c_long = 0x124;
pub const SYS_renameat: c_long = 0x125;
pub const SYS_linkat: c_long = 0x126;
pub const SYS_symlinkat: c_long = 0x127;
pub const SYS_readlinkat: c_long = 0x128;
pub const SYS_fchmodat: c_long = 0x129;
pub const SYS_faccessat: c_long = 0x12a;
pub const SYS_get_robust_list: c_long = 0x12b;
pub const SYS_set_robust_list: c_long = 0x12c;
pub const SYS_move_pages: c_long = 0x12d;
pub const SYS_getcpu: c_long = 0x12e;
pub const SYS_epoll_pwait: c_long = 0x12f;
pub const SYS_utimensat: c_long = 0x130;
pub const SYS_signalfd: c_long = 0x131;
pub const SYS_timerfd_create: c_long = 0x132;
pub const SYS_eventfd: c_long = 0x133;
pub const SYS_sync_file_range2: c_long = 0x134;
pub const SYS_fallocate: c_long = 0x135;
pub const SYS_subpage_prot: c_long = 0x136;
pub const SYS_timerfd_settime32: c_long = 0x137;
pub const SYS_timerfd_gettime32: c_long = 0x138;
pub const SYS_signalfd4: c_long = 0x139;
pub const SYS_eventfd2: c_long = 0x13a;
pub const SYS_epoll_create1: c_long = 0x13b;
pub const SYS_dup3: c_long = 0x13c;
pub const SYS_pipe2: c_long = 0x13d;
pub const SYS_inotify_init1: c_long = 0x13e;
pub const SYS_perf_event_open: c_long = 0x13f;
pub const SYS_preadv: c_long = 0x140;
pub const SYS_pwritev: c_long = 0x141;
pub const SYS_rt_tgsigqueueinfo: c_long = 0x142;
pub const SYS_fanotify_init: c_long = 0x143;
pub const SYS_fanotify_mark: c_long = 0x144;
pub const SYS_prlimit64: c_long = 0x145;
pub const SYS_socket: c_long = 0x146;
pub const SYS_bind: c_long = 0x147;
pub const SYS_connect: c_long = 0x148;
pub const SYS_listen: c_long = 0x149;
pub const SYS_accept: c_long = 0x14a;
pub const SYS_getsockname: c_long = 0x14b;
pub const SYS_getpeername: c_long = 0x14c;
pub const SYS_socketpair: c_long = 0x14d;
pub const SYS_send: c_long = 0x14e;
pub const SYS_sendto: c_long = 0x14f;
pub const SYS_recv: c_long = 0x150;
pub const SYS_recvfrom: c_long = 0x151;
pub const SYS_shutdown: c_long = 0x152;
pub const SYS_setsockopt: c_long = 0x153;
pub const SYS_getsockopt: c_long = 0x154;
pub const SYS_sendmsg: c_long = 0x155;
pub const SYS_recvmsg: c_long = 0x156;
pub const SYS_recvmmsg: c_long = 0x157;
pub const SYS_accept4: c_long = 0x158;
pub const SYS_name_to_handle_at: c_long = 0x159;
pub const SYS_open_by_handle_at: c_long = 0x15a;
pub const SYS_clock_adjtime: c_long = 0x15b;
pub const SYS_syncfs: c_long = 0x15c;
pub const SYS_sendmmsg: c_long = 0x15d;
pub const SYS_setns: c_long = 0x15e;
pub const SYS_process_vm_readv: c_long = 0x15f;
pub const SYS_process_vm_writev: c_long = 0x160;
pub const SYS_finit_module: c_long = 0x161;
pub const SYS_kcmp: c_long = 0x162;
pub const SYS_sched_setattr: c_long = 0x163;
pub const SYS_sched_getattr: c_long = 0x164;
pub const SYS_renameat2: c_long = 0x165;
pub const SYS_seccomp: c_long = 0x166;
pub const SYS_getrandom: c_long = 0x167;
pub const SYS_memfd_create: c_long = 0x168;
pub const SYS_bpf: c_long = 0x169;
pub const SYS_execveat: c_long = 0x16a;
pub const SYS_switch_endian: c_long = 0x16b;
pub const SYS_userfaultfd: c_long = 0x16c;
pub const SYS_membarrier: c_long = 0x16d;
pub const SYS_mlock2: c_long = 0x17a;
pub const SYS_copy_file_range: c_long = 0x17b;
pub const SYS_preadv2: c_long = 0x17c;
pub const SYS_pwritev2: c_long = 0x17d;
pub const SYS_kexec_file_load: c_long = 0x17e;
pub const SYS_statx: c_long = 0x17f;
pub const SYS_pkey_alloc: c_long = 0x180;
pub const SYS_pkey_free: c_long = 0x181;
pub const SYS_pkey_mprotect: c_long = 0x182;
pub const SYS_rseq: c_long = 0x183;
pub const SYS_io_pgetevents: c_long = 0x184;
