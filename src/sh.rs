...
pub const SYS_add_key: c_long = 285;
pub const SYS_request_key: c_long = 286;
pub const SYS_keyctl: c_long = 287;
pub const SYS_ioprio_set: c_long = 288;
pub const SYS_ioprio_get: c_long = 289;
pub const SYS_inotify_init: c_long = 290;
pub const SYS_inotify_add_watch: c_long = 291;
pub const SYS_inotify_rm_watch: c_long = 292;
...
pub const SYS_timerfd_settime32: c_long = 325;
pub const SYS_timerfd_gettime32: c_long = 326;
...
pub const SYS_socket: c_long = 340;
pub const SYS_bind: c_long = 341;
pub const SYS_connect: c_long = 342;
pub const SYS_listen: c_long = 343;
pub const SYS_accept: c_long = 344;
pub const SYS_getsockname: c_long = 345;
pub const SYS_getpeername: c_long = 346;
pub const SYS_socketpair: c_long = 347;
pub const SYS_send: c_long = 348;
pub const SYS_sendto: c_long = 349;
pub const SYS_recv: c_long = 350;
pub const SYS_recvfrom: c_long = 351;
pub const SYS_shutdown: c_long = 352;
pub const SYS_setsockopt: c_long = 353;
pub const SYS_getsockopt: c_long = 354;
pub const SYS_sendmsg: c_long = 355;
pub const SYS_recvmsg: c_long = 356;
pub const SYS_recvmmsg: c_long = 357;
pub const SYS_accept4: c_long = 358;
pub const SYS_name_to_handle_at: c_long = 359;
pub const SYS_open_by_handle_at: c_long = 360;
pub const SYS_clock_adjtime: c_long = 361;
pub const SYS_syncfs: c_long = 362;
pub const SYS_sendmmsg: c_long = 363;
pub const SYS_setns: c_long = 364;
pub const SYS_process_vm_readv: c_long = 365;
pub const SYS_process_vm_writev: c_long = 366;
pub const SYS_kcmp: c_long = 367;
pub const SYS_finit_module: c_long = 368;
pub const SYS_sched_getattr: c_long = 369;
pub const SYS_sched_setattr: c_long = 370;
pub const SYS_renameat2: c_long = 371;
pub const SYS_seccomp: c_long = 372;
pub const SYS_getrandom: c_long = 373;
pub const SYS_memfd_create: c_long = 374;
pub const SYS_bpf: c_long = 375;
pub const SYS_execveat: c_long = 376;
pub const SYS_userfaultfd: c_long = 377;
pub const SYS_membarrier: c_long = 378;
pub const SYS_mlock2: c_long = 379;
pub const SYS_copy_file_range: c_long = 380;
pub const SYS_preadv2: c_long = 381;
pub const SYS_pwritev2: c_long = 382;
