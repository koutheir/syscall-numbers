...
pub const SYS_add_key: c_long = 0x11d;
pub const SYS_request_key: c_long = 0x11e;
pub const SYS_keyctl: c_long = 0x11f;
pub const SYS_ioprio_set: c_long = 0x120;
pub const SYS_ioprio_get: c_long = 0x121;
pub const SYS_inotify_init: c_long = 0x122;
pub const SYS_inotify_add_watch: c_long = 0x123;
pub const SYS_inotify_rm_watch: c_long = 0x124;
...
pub const SYS_socket: c_long = 0x154;
pub const SYS_bind: c_long = 0x155;
pub const SYS_connect: c_long = 0x156;
pub const SYS_listen: c_long = 0x157;
pub const SYS_accept: c_long = 0x158;
pub const SYS_getsockname: c_long = 0x159;
pub const SYS_getpeername: c_long = 0x15a;
pub const SYS_socketpair: c_long = 0x15b;
pub const SYS_send: c_long = 0x15c;
pub const SYS_sendto: c_long = 0x15d;
pub const SYS_recv: c_long = 0x15e;
pub const SYS_recvfrom: c_long = 0x15f;
pub const SYS_shutdown: c_long = 0x160;
pub const SYS_setsockopt: c_long = 0x161;
pub const SYS_getsockopt: c_long = 0x162;
pub const SYS_sendmsg: c_long = 0x163;
pub const SYS_recvmsg: c_long = 0x164;
pub const SYS_recvmmsg: c_long = 0x165;
pub const SYS_accept4: c_long = 0x166;
pub const SYS_name_to_handle_at: c_long = 0x167;
pub const SYS_open_by_handle_at: c_long = 0x168;
pub const SYS_clock_adjtime: c_long = 0x169;
pub const SYS_syncfs: c_long = 0x16a;
pub const SYS_sendmmsg: c_long = 0x16b;
pub const SYS_setns: c_long = 0x16c;
pub const SYS_process_vm_readv: c_long = 0x16d;
pub const SYS_process_vm_writev: c_long = 0x16e;
pub const SYS_kcmp: c_long = 0x16f;
pub const SYS_finit_module: c_long = 0x170;
pub const SYS_sched_getattr: c_long = 0x171;
pub const SYS_sched_setattr: c_long = 0x172;
pub const SYS_renameat2: c_long = 0x173;
pub const SYS_seccomp: c_long = 0x174;
pub const SYS_getrandom: c_long = 0x175;
pub const SYS_memfd_create: c_long = 0x176;
pub const SYS_bpf: c_long = 0x177;
pub const SYS_execveat: c_long = 0x178;
pub const SYS_userfaultfd: c_long = 0x179;
pub const SYS_membarrier: c_long = 0x17a;
pub const SYS_mlock2: c_long = 0x17b;
pub const SYS_copy_file_range: c_long = 0x17c;
pub const SYS_preadv2: c_long = 0x17d;
pub const SYS_pwritev2: c_long = 0x17e;
