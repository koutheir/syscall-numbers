...
pub const SYS_restart_syscall: c_long = 0x7;
...
pub const SYS_lookup_dcookie: c_long = 0x6e;
...
pub const SYS_select: c_long = 0x8e;
...
pub const SYS_getrlimit: c_long = 0xbf;
pub const SYS_lchown: c_long = 0xc6;
pub const SYS_getuid: c_long = 0xc7;
pub const SYS_getgid: c_long = 0xc8;
pub const SYS_geteuid: c_long = 0xc9;
pub const SYS_getegid: c_long = 0xca;
pub const SYS_setreuid: c_long = 0xcb;
pub const SYS_setregid: c_long = 0xcc;
pub const SYS_getgroups: c_long = 0xcd;
pub const SYS_setgroups: c_long = 0xce;
pub const SYS_fchown: c_long = 0xcf;
pub const SYS_setresuid: c_long = 0xd0;
pub const SYS_getresuid: c_long = 0xd1;
pub const SYS_setresgid: c_long = 0xd2;
pub const SYS_getresgid: c_long = 0xd3;
pub const SYS_chown: c_long = 0xd4;
pub const SYS_setuid: c_long = 0xd5;
pub const SYS_setgid: c_long = 0xd6;
pub const SYS_setfsuid: c_long = 0xd7;
pub const SYS_setfsgid: c_long = 0xd8;
...
pub const SYS_readahead: c_long = 0xde;
pub const SYS_setxattr: c_long = 0xe0;
pub const SYS_lsetxattr: c_long = 0xe1;
pub const SYS_fsetxattr: c_long = 0xe2;
pub const SYS_getxattr: c_long = 0xe3;
pub const SYS_lgetxattr: c_long = 0xe4;
pub const SYS_fgetxattr: c_long = 0xe5;
pub const SYS_listxattr: c_long = 0xe6;
pub const SYS_llistxattr: c_long = 0xe7;
pub const SYS_flistxattr: c_long = 0xe8;
pub const SYS_removexattr: c_long = 0xe9;
pub const SYS_lremovexattr: c_long = 0xea;
pub const SYS_fremovexattr: c_long = 0xeb;
pub const SYS_gettid: c_long = 0xec;
pub const SYS_tkill: c_long = 0xed;
pub const SYS_futex: c_long = 0xee;
pub const SYS_sched_setaffinity: c_long = 0xef;
pub const SYS_sched_getaffinity: c_long = 0xf0;
pub const SYS_tgkill: c_long = 0xf1;
pub const SYS_io_setup: c_long = 0xf3;
pub const SYS_io_destroy: c_long = 0xf4;
pub const SYS_io_getevents: c_long = 0xf5;
pub const SYS_io_submit: c_long = 0xf6;
pub const SYS_io_cancel: c_long = 0xf7;
pub const SYS_exit_group: c_long = 0xf8;
pub const SYS_epoll_create: c_long = 0xf9;
pub const SYS_epoll_ctl: c_long = 0xfa;
pub const SYS_epoll_wait: c_long = 0xfb;
pub const SYS_set_tid_address: c_long = 0xfc;
pub const SYS_fadvise64: c_long = 0xfd;
pub const SYS_timer_create: c_long = 0xfe;
pub const SYS_timer_settime: c_long = 0xff;
pub const SYS_timer_gettime: c_long = 0x100;
pub const SYS_timer_getoverrun: c_long = 0x101;
pub const SYS_timer_delete: c_long = 0x102;
pub const SYS_clock_settime: c_long = 0x103;
pub const SYS_clock_gettime: c_long = 0x104;
pub const SYS_clock_getres: c_long = 0x105;
pub const SYS_clock_nanosleep: c_long = 0x106;
pub const SYS_statfs64: c_long = 0x109;
pub const SYS_fstatfs64: c_long = 0x10a;
pub const SYS_remap_file_pages: c_long = 0x10b;
pub const SYS_mbind: c_long = 0x10c;
pub const SYS_get_mempolicy: c_long = 0x10d;
pub const SYS_set_mempolicy: c_long = 0x10e;
pub const SYS_mq_open: c_long = 0x10f;
pub const SYS_mq_unlink: c_long = 0x110;
pub const SYS_mq_timedsend: c_long = 0x111;
pub const SYS_mq_timedreceive: c_long = 0x112;
pub const SYS_mq_notify: c_long = 0x113;
pub const SYS_mq_getsetattr: c_long = 0x114;
pub const SYS_kexec_load: c_long = 0x115;
pub const SYS_add_key: c_long = 0x116;
pub const SYS_request_key: c_long = 0x117;
pub const SYS_keyctl: c_long = 0x118;
pub const SYS_waitid: c_long = 0x119;
pub const SYS_ioprio_set: c_long = 0x11a;
pub const SYS_ioprio_get: c_long = 0x11b;
pub const SYS_inotify_init: c_long = 0x11c;
pub const SYS_inotify_add_watch: c_long = 0x11d;
pub const SYS_inotify_rm_watch: c_long = 0x11e;
pub const SYS_migrate_pages: c_long = 0x11f;
pub const SYS_openat: c_long = 0x120;
pub const SYS_mkdirat: c_long = 0x121;
pub const SYS_mknodat: c_long = 0x122;
pub const SYS_fchownat: c_long = 0x123;
pub const SYS_futimesat: c_long = 0x124;
pub const SYS_newfstatat: c_long = 0x125;
pub const SYS_unlinkat: c_long = 0x126;
pub const SYS_renameat: c_long = 0x127;
pub const SYS_linkat: c_long = 0x128;
pub const SYS_symlinkat: c_long = 0x129;
pub const SYS_readlinkat: c_long = 0x12a;
pub const SYS_fchmodat: c_long = 0x12b;
pub const SYS_faccessat: c_long = 0x12c;
pub const SYS_pselect6: c_long = 0x12d;
pub const SYS_ppoll: c_long = 0x12e;
pub const SYS_unshare: c_long = 0x12f;
pub const SYS_set_robust_list: c_long = 0x130;
pub const SYS_get_robust_list: c_long = 0x131;
pub const SYS_splice: c_long = 0x132;
pub const SYS_sync_file_range: c_long = 0x133;
pub const SYS_tee: c_long = 0x134;
pub const SYS_vmsplice: c_long = 0x135;
pub const SYS_move_pages: c_long = 0x136;
pub const SYS_getcpu: c_long = 0x137;
pub const SYS_epoll_pwait: c_long = 0x138;
pub const SYS_utimes: c_long = 0x139;
pub const SYS_fallocate: c_long = 0x13a;
pub const SYS_utimensat: c_long = 0x13b;
pub const SYS_signalfd: c_long = 0x13c;
pub const SYS_timerfd: c_long = 0x13d;
pub const SYS_eventfd: c_long = 0x13e;
pub const SYS_timerfd_create: c_long = 0x13f;
pub const SYS_timerfd_settime: c_long = 0x140;
pub const SYS_timerfd_gettime: c_long = 0x141;
pub const SYS_signalfd4: c_long = 0x142;
pub const SYS_eventfd2: c_long = 0x143;
pub const SYS_inotify_init1: c_long = 0x144;
pub const SYS_pipe2: c_long = 0x145;
pub const SYS_dup3: c_long = 0x146;
pub const SYS_epoll_create1: c_long = 0x147;
pub const SYS_preadv: c_long = 0x148;
pub const SYS_pwritev: c_long = 0x149;
pub const SYS_rt_tgsigqueueinfo: c_long = 0x14a;
pub const SYS_perf_event_open: c_long = 0x14b;
pub const SYS_fanotify_init: c_long = 0x14c;
pub const SYS_fanotify_mark: c_long = 0x14d;
pub const SYS_prlimit64: c_long = 0x14e;
pub const SYS_name_to_handle_at: c_long = 0x14f;
pub const SYS_open_by_handle_at: c_long = 0x150;
pub const SYS_clock_adjtime: c_long = 0x151;
pub const SYS_syncfs: c_long = 0x152;
pub const SYS_setns: c_long = 0x153;
pub const SYS_process_vm_readv: c_long = 0x154;
pub const SYS_process_vm_writev: c_long = 0x155;
pub const SYS_s390_runtime_instr: c_long = 0x156;
pub const SYS_kcmp: c_long = 0x157;
pub const SYS_finit_module: c_long = 0x158;
pub const SYS_sched_setattr: c_long = 0x159;
pub const SYS_sched_getattr: c_long = 0x15a;
pub const SYS_renameat2: c_long = 0x15b;
pub const SYS_seccomp: c_long = 0x15c;
pub const SYS_getrandom: c_long = 0x15d;
pub const SYS_memfd_create: c_long = 0x15e;
pub const SYS_bpf: c_long = 0x15f;
pub const SYS_s390_pci_mmio_write: c_long = 0x160;
pub const SYS_s390_pci_mmio_read: c_long = 0x161;
pub const SYS_execveat: c_long = 0x162;
pub const SYS_userfaultfd: c_long = 0x163;
pub const SYS_membarrier: c_long = 0x164;
pub const SYS_recvmmsg: c_long = 0x165;
pub const SYS_sendmmsg: c_long = 0x166;
...
pub const SYS_mlock2: c_long = 0x176;
pub const SYS_copy_file_range: c_long = 0x177;
pub const SYS_preadv2: c_long = 0x178;
pub const SYS_pwritev2: c_long = 0x179;
pub const SYS_s390_guarded_storage: c_long = 0x17a;
pub const SYS_statx: c_long = 0x17b;
pub const SYS_s390_sthyi: c_long = 0x17c;
pub const SYS_kexec_file_load: c_long = 0x17d;
pub const SYS_io_pgetevents: c_long = 0x17e;
pub const SYS_rseq: c_long = 0x17f;
pub const SYS_pkey_mprotect: c_long = 0x180;
pub const SYS_pkey_alloc: c_long = 0x181;
pub const SYS_pkey_free: c_long = 0x182;
...
pub(crate) const SYS_CALL_BASE_INDEX: c_long = 0x1;
