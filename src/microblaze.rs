...
pub const SYS_timer_settime32: c_long = 0x104;
pub const SYS_timer_gettime32: c_long = 0x105;
pub const SYS_timer_getoverrun: c_long = 0x106;
pub const SYS_timer_delete: c_long = 0x107;
pub const SYS_clock_settime32: c_long = 0x108;
pub const SYS_clock_gettime32: c_long = 0x109;
pub const SYS_clock_getres_time32: c_long = 0x10a;
pub const SYS_clock_nanosleep_time32: c_long = 0x10b;
...
pub const SYS_mq_unlink: c_long = 0x116;
pub const SYS_mq_timedsend: c_long = 0x117;
pub const SYS_mq_timedreceive: c_long = 0x118;
pub const SYS_mq_notify: c_long = 0x119;
pub const SYS_mq_getsetattr: c_long = 0x11a;
...
pub const SYS_semtimedop: c_long = 0x145;
pub const SYS_timerfd_settime32: c_long = 0x146;
pub const SYS_timerfd_gettime32: c_long = 0x147;
pub const SYS_semctl: c_long = 0x148;
pub const SYS_semget: c_long = 0x149;
pub const SYS_semop: c_long = 0x14a;
pub const SYS_msgctl: c_long = 0x14b;
pub const SYS_msgget: c_long = 0x14c;
pub const SYS_msgrcv: c_long = 0x14d;
pub const SYS_msgsnd: c_long = 0x14e;
pub const SYS_shmat: c_long = 0x14f;
pub const SYS_shmctl: c_long = 0x150;
pub const SYS_shmdt: c_long = 0x151;
pub const SYS_shmget: c_long = 0x152;
pub const SYS_signalfd4: c_long = 0x153;
pub const SYS_eventfd2: c_long = 0x154;
pub const SYS_epoll_create1: c_long = 0x155;
pub const SYS_dup3: c_long = 0x156;
pub const SYS_pipe2: c_long = 0x157;
pub const SYS_inotify_init1: c_long = 0x158;
pub const SYS_socket: c_long = 0x159;
pub const SYS_socketpair: c_long = 0x15a;
pub const SYS_bind: c_long = 0x15b;
pub const SYS_listen: c_long = 0x15c;
pub const SYS_accept: c_long = 0x15d;
pub const SYS_connect: c_long = 0x15e;
pub const SYS_getsockname: c_long = 0x15f;
pub const SYS_getpeername: c_long = 0x160;
pub const SYS_sendto: c_long = 0x161;
pub const SYS_send: c_long = 0x162;
pub const SYS_recvfrom: c_long = 0x163;
pub const SYS_recv: c_long = 0x164;
pub const SYS_setsockopt: c_long = 0x165;
pub const SYS_getsockopt: c_long = 0x166;
pub const SYS_shutdown: c_long = 0x167;
pub const SYS_sendmsg: c_long = 0x168;
pub const SYS_recvmsg: c_long = 0x169;
pub const SYS_accept4: c_long = 0x16a;
pub const SYS_preadv: c_long = 0x16b;
pub const SYS_pwritev: c_long = 0x16c;
pub const SYS_rt_tgsigqueueinfo: c_long = 0x16d;
pub const SYS_perf_event_open: c_long = 0x16e;
pub const SYS_recvmmsg: c_long = 0x16f;
pub const SYS_fanotify_init: c_long = 0x170;
pub const SYS_fanotify_mark: c_long = 0x171;
pub const SYS_prlimit64: c_long = 0x172;
pub const SYS_name_to_handle_at: c_long = 0x173;
pub const SYS_open_by_handle_at: c_long = 0x174;
pub const SYS_clock_adjtime: c_long = 0x175;
pub const SYS_syncfs: c_long = 0x176;
pub const SYS_setns: c_long = 0x177;
pub const SYS_sendmmsg: c_long = 0x178;
pub const SYS_process_vm_readv: c_long = 0x179;
pub const SYS_process_vm_writev: c_long = 0x17a;
pub const SYS_kcmp: c_long = 0x17b;
pub const SYS_finit_module: c_long = 0x17c;
pub const SYS_sched_setattr: c_long = 0x17d;
pub const SYS_sched_getattr: c_long = 0x17e;
pub const SYS_renameat2: c_long = 0x17f;
pub const SYS_seccomp: c_long = 0x180;
pub const SYS_getrandom: c_long = 0x181;
pub const SYS_memfd_create: c_long = 0x182;
pub const SYS_bpf: c_long = 0x183;
pub const SYS_execveat: c_long = 0x184;
pub const SYS_userfaultfd: c_long = 0x185;
pub const SYS_membarrier: c_long = 0x186;
pub const SYS_mlock2: c_long = 0x187;
pub const SYS_copy_file_range: c_long = 0x188;
pub const SYS_preadv2: c_long = 0x189;
pub const SYS_pwritev2: c_long = 0x18a;
pub const SYS_pkey_mprotect: c_long = 0x18b;
pub const SYS_pkey_alloc: c_long = 0x18c;
pub const SYS_pkey_free: c_long = 0x18d;
pub const SYS_statx: c_long = 0x18e;
pub const SYS_io_pgetevents: c_long = 0x18f;
pub const SYS_rseq: c_long = 0x190;
