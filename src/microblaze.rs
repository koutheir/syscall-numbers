...
pub const SYS_gettimeofday_time32: c_long = 78;
pub const SYS_settimeofday_time32: c_long = 79;
...
pub const SYS_timer_settime32: c_long = 260;
pub const SYS_timer_gettime32: c_long = 261;
pub const SYS_timer_getoverrun: c_long = 262;
pub const SYS_timer_delete: c_long = 263;
pub const SYS_clock_settime32: c_long = 264;
pub const SYS_clock_gettime32: c_long = 265;
pub const SYS_clock_getres_time32: c_long = 266;
pub const SYS_clock_nanosleep_time32: c_long = 267;
...
pub const SYS_semtimedop: c_long = 325;
pub const SYS_timerfd_settime32: c_long = 326;
pub const SYS_timerfd_gettime32: c_long = 327;
pub const SYS_semctl: c_long = 328;
pub const SYS_semget: c_long = 329;
pub const SYS_semop: c_long = 330;
pub const SYS_msgctl: c_long = 331;
pub const SYS_msgget: c_long = 332;
pub const SYS_msgrcv: c_long = 333;
pub const SYS_msgsnd: c_long = 334;
pub const SYS_shmat: c_long = 335;
pub const SYS_shmctl: c_long = 336;
pub const SYS_shmdt: c_long = 337;
pub const SYS_shmget: c_long = 338;
pub const SYS_signalfd4: c_long = 339;
pub const SYS_eventfd2: c_long = 340;
pub const SYS_epoll_create1: c_long = 341;
pub const SYS_dup3: c_long = 342;
pub const SYS_pipe2: c_long = 343;
pub const SYS_inotify_init1: c_long = 344;
pub const SYS_socket: c_long = 345;
pub const SYS_socketpair: c_long = 346;
pub const SYS_bind: c_long = 347;
pub const SYS_listen: c_long = 348;
pub const SYS_accept: c_long = 349;
pub const SYS_connect: c_long = 350;
pub const SYS_getsockname: c_long = 351;
pub const SYS_getpeername: c_long = 352;
pub const SYS_sendto: c_long = 353;
pub const SYS_send: c_long = 354;
pub const SYS_recvfrom: c_long = 355;
pub const SYS_recv: c_long = 356;
pub const SYS_setsockopt: c_long = 357;
pub const SYS_getsockopt: c_long = 358;
pub const SYS_shutdown: c_long = 359;
pub const SYS_sendmsg: c_long = 360;
pub const SYS_recvmsg: c_long = 361;
pub const SYS_accept4: c_long = 362;
pub const SYS_preadv: c_long = 363;
pub const SYS_pwritev: c_long = 364;
pub const SYS_rt_tgsigqueueinfo: c_long = 365;
pub const SYS_perf_event_open: c_long = 366;
pub const SYS_recvmmsg: c_long = 367;
pub const SYS_fanotify_init: c_long = 368;
pub const SYS_fanotify_mark: c_long = 369;
pub const SYS_prlimit64: c_long = 370;
pub const SYS_name_to_handle_at: c_long = 371;
pub const SYS_open_by_handle_at: c_long = 372;
pub const SYS_clock_adjtime: c_long = 373;
pub const SYS_syncfs: c_long = 374;
pub const SYS_setns: c_long = 375;
pub const SYS_sendmmsg: c_long = 376;
pub const SYS_process_vm_readv: c_long = 377;
pub const SYS_process_vm_writev: c_long = 378;
pub const SYS_kcmp: c_long = 379;
pub const SYS_finit_module: c_long = 380;
pub const SYS_sched_setattr: c_long = 381;
pub const SYS_sched_getattr: c_long = 382;
pub const SYS_renameat2: c_long = 383;
pub const SYS_seccomp: c_long = 384;
pub const SYS_getrandom: c_long = 385;
pub const SYS_memfd_create: c_long = 386;
pub const SYS_bpf: c_long = 387;
pub const SYS_execveat: c_long = 388;
pub const SYS_userfaultfd: c_long = 389;
pub const SYS_membarrier: c_long = 390;
pub const SYS_mlock2: c_long = 391;
pub const SYS_copy_file_range: c_long = 392;
pub const SYS_preadv2: c_long = 393;
pub const SYS_pwritev2: c_long = 394;
pub const SYS_pkey_mprotect: c_long = 395;
pub const SYS_pkey_alloc: c_long = 396;
pub const SYS_pkey_free: c_long = 397;
pub const SYS_statx: c_long = 398;
pub const SYS_io_pgetevents: c_long = 399;
pub const SYS_rseq: c_long = 400;
...
pub(crate) const SYS_CALL_BASE_INDEX: c_long = 0;
